...
<body>
  ...
  <div class="codepen-form__inner">
    ...
    <input type="datetime-local" class="form-control" id="form-email" name="startdate" required>
      <label for="form-email">Leaving Date and time</label>
    </div>
    <div class="codepen-form__item form-group ">
    <input type="datetime-local" class="form-control" id="form-email" name="enddate" required >
      <label for="form-email">Arriving Date and time</label>
    </div>
    <div class="codepen-form__item form-group">
      <input type="text" class="form-control" id="form-name" name="place" required>
      <label for="form-name">Leave destination</label>
    </div>
    <div class="codepen-form__item form-group">
      <input type="text" class="form-control" id="form-phone" name="reason" required>
      <label for="form-phone">Reason for leave</label>
    </div>
    <div class="codepen-form__item form-group">
      <input type="text" class="form-control" id="form-shoe" name="transport" required>
      <label for="form-shoe">Mode of transport</label>
    </div>
    <div class="codepen-form__item form-group">
      <input type="Text" class="form-control " id="form-drink" name="callat" required>

      <label for="form-drink">Parents availability hours to contact</label>
    </div>
    <div class="btn-group">
    ...
    <script  src="js/outpass.js"></script>
